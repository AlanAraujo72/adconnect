...
#with io.open("D:/Users/alves.STJ/PycharmProjects/AD-SYNC/data_stj2.csv", "r", encoding="utf-8") as f1:
 #   data = f1.read()
 #   f1.close()
#file_row = data.split("\n")
file_row = pd.read_csv("D:/Users/alves.STJ/PycharmProjects/AD-SYNC/data_stj2.csv", delimiter=";")
...
q.execute_query(
    ...
    base_dn="OU=STI,OU=ST,OU=Usuarios,OU=AAPADM,OU=Usr e Cmp W2000,OU=Objetos do STJ,DC=STJ,DC=GOV,DC=BR"
)

pyad.set_defaults(ldap_server="sfwp-ad-01.stj.gov.br",
username="orch", password="Adm@stj2022")
